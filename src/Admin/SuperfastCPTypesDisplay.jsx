...
const SupCPTypesDisplay = () => {
    ...
    const [selectedSpeedFilter, setSelectedSpeedFilter] = useState({ label: "All Speed", value: "Yes" });
    ...
    if (isLoading) {
        return (
            <div className="flex justify-center items-center h-screen">
                ...
                <p className="ml-4">Loading Superfast CP Types...</p>
            </div>
        );
    }
            ...
            <div className="bg-white shadow-md rounded-lg overflow-hidden">
                <div className="p-6 bg-gray-100 border-b">
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <h1 className="text-2xl font-bold text-gray-900">Superfast CP Types Management</h1>
                    </div>
...
export default SupCPTypesDisplay;