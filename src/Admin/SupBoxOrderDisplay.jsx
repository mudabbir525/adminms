...
const SupBoxOrderDisplay = () => {
  ...
  const fetchOrders = async () => {
    try {
      const response = await fetch('https://mahaspice.desoftimp.com/ms3/get_sup_box_orders.php');
  ...
  return (
    <div className="container mx-auto p-4 space-y-4">
      <h1 className="text-2xl font-bold mb-6">Box Orders</h1>
...
export default SupBoxOrderDisplay;