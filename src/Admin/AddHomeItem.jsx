...
import { Upload, DollarSign, Utensils, Check, AlertCircle, Loader2 } from 'lucide-react';
                            ...
                            <div className="space-y-1.5">
                                ...
                                >
                                    <div className="text-center">
                                        ...
                                        <p className="text-sm text-gray-500 group-hover:text-blue-500 transition-colors">Click to upload image</p>
