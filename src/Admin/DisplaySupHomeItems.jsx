...
const DisplaySupHomeItems = () => {
    ...
    const fetchItems = async () => {
        try {
            const response = await fetch('https://mahaspice.desoftimp.com/ms3/getSupHomeItems.php');
            if (!response.ok) {
    ...
    const handleDelete = async (id) => {
        ...
        try {
            const response = await fetch('https://mahaspice.desoftimp.com/ms3/deleteSupHomeItems.php', {
                method: 'POST',
                headers: {
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-6">
                        ...
                        <button
                            onClick={() => window.location.href = '/superfast-add-home-items'}
                                ...
                                <div className="relative group">
                                    ...
                                    <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-30 transition-opacity flex items-center justify-center opacity-0 group-hover:opacity-100">
                                        <div className="flex gap-2">
                                            <button
                                                onClick={() => window.location.href = `/superfast-edit-home-items/${item.id}`}
...
export default DisplaySupHomeItems;